...
/* midi tempo message: 00 FF 51 03 [3-byte integer]
 * where integer is microseconds per beat
 * e.g. 00 FF 51 03 07 A1 20:
...
/* general control change: Bc v1 v2
 ...
 * 0x00, 0x20(bank MSB/LSB), 0x07(volume), 0x0A(pan)
 * 0x40(sustain pedal)
 */
 ...
 * where where c is channel(0 to F, Ch1 to Ch16 respectively),
